(() => {
  ...
  const GLOBAL_I18N = {
    de: {
      ...
      price_stock_note: "Ersatzteil-Verfügbarkeit wird beim WhatsApp-Check bestätigt.",
      price_selector_note: "Die endgültigen Kosten und Garantie hängen vom Zustand des Geräts und der gewählten Ersatzteilqualität ab. Original/Premium und günstige Varianten klären wir vorab.",
      repair_display: "Display",
      repair_oled_premium: "OLED Premium",
      repair_standard: "Standard",
      repair_battery: "Akku",
      repair_original_battery: "Original Akku OEM 99+%",
    ...
    uk: {
      ...
      price_stock_note: "Наявність запчастини підтвердимо під час запиту у WhatsApp.",
      price_selector_note: "Остаточна вартість і гарантія залежать від стану пристрою та обраної якості запчастини. Original/Premium і дешевші варіанти узгоджуємо до ремонту.",
      repair_display: "Дисплей",
      repair_oled_premium: "OLED Premium",
      repair_standard: "Стандарт",
      repair_battery: "Акумулятор",
      repair_original_battery: "Оригінальний акумулятор OEM 99+%",
  ...
  const EXTRA_I18N = {
    en: {
      ...
      price_stock_note: "Part availability will be confirmed during the WhatsApp check.",
      price_selector_note: "Final cost and warranty depend on the device condition and selected replacement part quality. Original/Premium and budget options are clarified upfront.",
      repair_display: "Display",
      repair_oled_premium: "OLED Premium",
      repair_standard: "Standard",
      repair_battery: "Battery",
      repair_original_battery: "Original battery OEM 99+%",
  ...
  const SIMPLE_LANGUAGE_OVERRIDES = {
    ru: {
      ...
      price_stock_note: "Наличие детали подтвердим во время WhatsApp-проверки.",
      price_selector_note: "Итоговая стоимость и гарантия зависят от состояния устройства и выбранного качества детали. Original/Premium и бюджетные варианты согласуем заранее.",
      repair_display: "Дисплей",
      repair_battery: "Аккумулятор",
      repair_original_battery: "Оригинальный аккумулятор OEM 99+%",
    ...
    pl: {
      ...
      price_stock_note: "Dostępność części potwierdzimy podczas sprawdzenia przez WhatsApp.",
      repair_display: "Wyświetlacz",
      repair_battery: "Bateria",
      repair_original_battery: "Oryginalna bateria OEM 99+%",
    ...
    it: {
      ...
      repair_original_battery: "Batteria originale OEM 99+%",
    ...
    ar: {
      ...
      repair_original_battery: "بطارية أصلية OEM 99+%",
    ...
    ku: {
      ...
      repair_original_battery: "Bataryaya orîjînal OEM 99+%",
    ...
    fr: {
      ...
      repair_original_battery: "Batterie originale OEM 99+%",
    ...
    sl: {
      ...
      repair_original_battery: "Originalna baterija OEM 99+%",
  ...
  Object.entries(SIMPLE_LANGUAGE_OVERRIDES).forEach(([lang, values]) => {
    GLOBAL_I18N[lang] = { ...GLOBAL_I18N.en, ...values };
  });
